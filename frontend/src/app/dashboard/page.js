...
export default function DashboardPage() {
  ...
  const soilNutrients = [
    { label: 'N', value: soilData ? soilData.nitrogen : 0, max: 100 },
    { label: 'P', value: soilData ? soilData.phosphorus : 0, max: 100 },
    { label: 'K', value: soilData ? soilData.potassium : 0, max: 100 },
    { label: 'pH', value: soilData ? soilData.ph : 0, max: 14 },
  ];
  ...
  const getSoilQuality = () => {
    if (!soilData) return { label: '--', desc: 'No soil data yet' };
      ...
      <main className={styles.mainContent}>
        ...
        {lastDiagnosis && (
          <div className={styles.alertBanner}>
            ...
            <div>
              <strong>{formatDisease(lastDiagnosis.disease)}</strong>
              <p>Check Disease Detection for details</p>
            </div>
          </div>
        )}
          ...
          <div className={styles.chartCard}>
            ...
            <div className={styles.barChart}>
              {soilData ? (
                ...
                <div style={{ textAlign: 'center', color: '#9ca3af', padding: '40px 0', width: '100%' }}>
                  No soil data yet — run a soil analysis first
                </div>
              )}
            </div>
          </div>
            ...
            <div className={styles.lineChart}>
              {moistureChartData.length > 0 ? (
                ...
                <div style={{ textAlign: 'center', color: '#9ca3af', padding: '60px 0' }}>
                  No reading history yet — run a soil analysis first
                </div>
              )}
            </div>
          </div>
